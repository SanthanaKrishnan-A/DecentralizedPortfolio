//Write and execute this code in Remix-Ethereum-IDE
...
contract Portfolio{
  ...
  string public imageLink="bafkreifvxldbbvxapjjindeyu3mlncuj7k62brnrymacspau44rjh7ksti";
  string public description="Over 6 months of practical experience with a good knowledge in blockchain development.";
  string public resumeLink="bafkreigbpwfkhl65oipxql327bropwxmei4hsff2ji5canfxzhho25rfmq";
  uint projectCount;
  ...
  function changeProject(string calldata _name,string calldata _description,string calldata _image,string calldata _githubLink,uint _projectCount) external{
      ...
      projects[_projectCount] = Project(projectCount,_name,_description,_image,_githubLink);
  }
